...
})({"7fTMd":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 60803;
...
async function getImages(page, search) {
    const res = await fetch(`https://pixabay.com/api/?image_type=photo&orientation=horizontal&q=${search}&page=${page}}&per_page=12&key=${API_KEY}`);
    return res.json();
}
...
inputRef.addEventListener('input', (0, _debounceDefault.default)(async (e)=>{
    page = 1;
    listRef.innerHTML = '';
...
},{"debounce":"7NAJV","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","basiclightbox":"io0Ts","basiclightbox/dist/basicLightbox.min.css":"lf3c2"}],"7NAJV":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"lf3c2":[function() {},{}]},["7fTMd","2R06K"], "2R06K", "parcelRequire4dec", {})
